  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiMsg: Message = {
        ...
        role: "assistant",
        content:
          "Thank you for sharing that with me. 💛 I want you to know that whatever you're feeling is completely valid. Let me ask — how would you describe your mood today? You can say anything that feels right.",
      };
